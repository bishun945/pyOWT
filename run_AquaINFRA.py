...
# path_root = "/h/koflux1/feederdata2/EighteenTB05/AquaINFRA/"
path_root = "/feederdata2/EighteenTB05/AquaINFRA/"

month_dir = ["onns_06-2023", "onns_07-2023", "onns_08-2023", "onns_09-2023"]

for i_month in range(len(month_dir)):
    ...
    for file in onns_files:
        ...
        o_png = os.path.join(o_path, os.path.basename(file)[:-3] + "_owt.png") 
        o_rgb = os.path.join(o_path, os.path.basename(file)[:-3] + "_rgb.png") 
