...
wavelen = np.array(
    [400, 412, 442, 490, 510, 560, 620, 666, 674, 682, 708, 754, 
     760, 764, 768, 778, 866, 886]
)
wavelen_sel = [str(i) for i in wavelen]
...
data = xr.Dataset(
    ...
    attrs={
        "description": "Training data for the OWT classification framework by Bi and Hieronymi (2024) - Sentinel-3/OLCI band setup",
        "reference": (
...
data.coords["wavelen"].attrs["description"] = "Nominal Sentinel-3 OLCI waveband"
...
# save data
data.to_netcdf(
    "/Users/Bi/Documents/GitHub/pyOWT/test_running/owt_BH2024_training_data_olci.nc",
    encoding=encoding,
)
