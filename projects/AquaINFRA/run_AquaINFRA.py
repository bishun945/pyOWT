...
python projects/AquaINFRA/run_AquaINFRA.py --input 'projects/AquaINFRA/data/Rrs_demo_AquaINFRA_msi.csv' --input_option 'csv' --sensor 'msi-sentinel-2a' --output 'projects/AquaINFRA/results/owt_result_hyper.txt' --output_option 1
python projects/AquaINFRA/run_AquaINFRA.py --input 'projects/AquaINFRA/data/Rrs_demo_AquaINFRA_ocli.csv' --input_option 'csv' --sensor 'olci-s3a' --output 'projects/AquaINFRA/results/owt_result_hyper.txt' --output_option 1
...
# satellite as input
python projects/AquaINFRA/run_AquaINFRA.py --input '/path/S3B_OL_2_WFR____20220703T075301_20220703T075601_20220704T171729_0179_067_363_2160_MAR_O_NT_003.SEN3.zip' --input_option 'sat' --sensor 'olci-s3a' --output '/path/to/save' --output_option 1
